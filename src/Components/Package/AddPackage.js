 ...
 if(state === false){
  ...
  return (
    <div>
        ...
        <form id="contact" action=" http://localhost:5000/api/addPackageProduct" method="post" encType='multipart/form-data'>
    ...
    <br></br>
    <fieldset>
      <input placeholder="Enter Disc.. " type="number" name='disc' tabindex="3" />
    </fieldset> 
    <fieldset>
