...
const UpdateHairProduct = () => {
  ...
  //const [pictures, SetPicture] = useState({file:[]});
...
const handler=(e)=>{
  ...
  const UpdateHair=()=>{
    ...
    //console.log(image)
    axios.put(`http://localhost:4000/api/updateProduct/${id}`,{p_name:p_name,price:price,category:category,rating:rating,image:Image},{
      headers: {
