...
const AddBridal = () => {
 ...
 if(state === false){
  ...
  <form id="contact" action=" http://localhost:5000/api/addBridalProduct" method="post" encType='multipart/form-data'>
    ...
    <fieldset>
      <input placeholder="Enter disc " type="text" name='disc'  />
    </fieldset>
    <fieldset>
      <input placeholder="Enter category " type="text" name='category'  />
    </fieldset> 
